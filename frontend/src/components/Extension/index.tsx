      ...
      <div className="max-w-3xl mx-auto sm:px-6 lg:px-8 py-10 space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Capture a paper straight from your browser into your library. This is a beta build - it's not on the Chrome
            Web Store or Firefox Add-ons yet, so for now it installs manually from the zip below. Once it's published,
            this page will link there instead.
          </p>
        </div>
        ...
        <div className="text-sm text-gray-600 border-t border-gray-200 pt-4">
          After installing, open the extension's options page and set your server URL and an API token - create one on
          the{' '}
